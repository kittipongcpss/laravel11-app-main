...
const page = usePage();
const form = useForm({
    name: page.props.department.name
})
...
const onHandleSubmit = () => {
    form.put(route("department.update", page.props.department?.id),{
...
<form @submit.prevent="onHandleSubmit()" novalidate>
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">แก้ไข ข้อมูลแผนก</label>
